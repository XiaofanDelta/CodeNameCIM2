ClientEvents.lang("zh_cn", (event) => {
	...
	addItemLang("moon_dust", "月岩粉")
	addItemLang("pyrolyzed_moon_rock_residue", "热解月岩残渣")
	addItemLang("moon_crystal_source", "晶源结晶")
	addItemLang("roasted_moon_crystal_source", "焙烧结晶")
	...
	addItemLang("single_layer_graphene", "单层石墨烯")
	addItemLang("graphene_plate", "石墨烯板")
	addItemLang("nano_composite_plate", "纳米复合板")
	addItemLang("fluoride_containing_waste", "含氟废渣")
	addItemLang("refined_nuke_waste", "精炼核废料")
	addItemLang("refined_radiation_rock", "精炼辐射岩")
	addItemLang("acid_washed_radiation_rock", "酸洗辐射岩")
	addItemLang("dense_oxide_film", "致密氧化物薄膜")
	addItemLang("reinforced_nano_composite_plate", "强化纳米复合板")
	addItemLang("sulfur_containing_mixture", "含硫混合物")
	addItemLang("mars_dust", "火星岩粉")
	addItemLang("pyrolyzed_mars_rock_residue", "热解火星岩")
	addItemLang("raw_gemanium", "粗锗")
	addItemLang("refined_gemanium", "锗精矿")
	addItemLang("pure_gemanium_dust", "高纯锗粉")
	addItemLang("roasted_gemanium_crystal", "焙烧锗晶")
	addItemLang("doped_gemanium_crystal", "掺杂锗晶")
	addItemLang("carbide_reduced_germanium_iron_mixture", "碳化还原锗铁混合物")
	addItemLang("carbon_reinforced_ceramic_body", "碳强化陶瓷胚体")
	addItemLang("restorative_ceramic_body", "还原性陶瓷胚体")
	addItemLang("enriched_ceramic_body", "富集陶瓷胚体")
	addItemLang("high_temperature_optical_ceramic", "高温光导陶瓷")
	addItemLang("reinforced_structure_ceramic", "强化结构陶瓷")
	addItemLang("galena_dust", "方铅岩粉")
	addItemLang("magnetic_source", "磁性源质")
	addItemLang("iron_containing_slag", "含铁矿渣")
	addItemLang("azure_magnetic_source", "青磁性源质")
	addItemLang("scarlet_magnetic_source", "赤磁性源质")
	addItemLang("magnetic_mixure", "磁性混合物")
	addItemLang("rich_azure_magnetic_mixure", "偏青钕混合物")
	addItemLang("rich_scarlet_magnetic_mixure", "偏赤钕混合物")
	addItemLang("azure_magnetic_ceramic", "青钕磁性陶瓷")
	addItemLang("scarlet_magnetic_ceramic", "赤钕磁性陶瓷")
	addItemLang("magnetic_ceramic", "磁性陶瓷")
	addItemLang("piezoelectric_ceramic", "压电陶瓷")
	addItemLang("scarlet_magnetic_dust", "赤钕粉")
	addItemLang("azure_magnetic_dust", "青钕粉")
	addItemLang("enriched_radiation_rock", "富集辐射岩")
	addItemLang("moon_crystal_dust", "晶矿粉")
	addItemLang("crystal_plate", "晶板")
	addItemLang("quartz_sand", "石英砂")
	addItemLang("enriched_germanium_iron_mixture", "富集锗铁混合物")
	addItemLang("reduced_iron_containing_slag", "还原性含铁矿渣")
	addItemLang("strong_reduced_iron_containing_slag", "强还原性含铁矿渣")
	addItemLang("reduced_iron_slag", "去铁矿渣")
	addItemLang("lead_slag", "铅矿渣")
	addItemLang("plating_galena_ceramic", "镀层方铅陶瓷")
	addItemLang("galena_wafer", "方铅晶圆")
	addItemLang("galena_enamel", "方铅釉料")
	addItemLang("galena_quartz", "方铅石英")
	addItemLang("reduced_iron_galena_quartz", "去铁方铅石英")
	addItemLang("enriched_galena_quartz", "富集方铅石英")
	addItemLang("composite_ceramic_substrates", "复合陶瓷基板")
