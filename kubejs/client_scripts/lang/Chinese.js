ClientEvents.lang("zh_cn", (event) => {
	...
	// 制作组fumo
	addCommonTooltipLang("cmi:re_construction","主创\n策划\n美工")
	addCommonTooltipLang("cmi:qi_month","KubeJS程序\nMod程序\n美工")
	addCommonTooltipLang("cmi:eternalsnowstorm","主策划\nKubeJS程序\nMod程序")
	addCommonTooltipLang("cmi:117458866249","KubeJS程序")
	addCommonTooltipLang("cmi:fiber_optics","KubeJS程序\nMod程序")
	addCommonTooltipLang("cmi:random_mechanism","KubeJS程序")
	addCommonTooltipLang("cmi:sakura_star_cn","Github仓库管理\n社区管理")
	...
	addCommonTooltipLang("cmi:flash_yi","策划\n任务撰写")
